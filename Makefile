...
override LDFLAGS = -X proofread-show/pkg/util.version=$(VERSION) \
-X proofread-show/pkg/util.buildDate=${BUILD_DATE} \
-X proofread-show/pkg/util.gitCommit=${GIT_COMMIT} \
-X proofread-show/pkg/util.gitTreeState=${GIT_TREE_STATE}

ifneq ($(GIT_TAG),)
override LDFLAGS += -X proofread-show/pkg/util.gitTag=${GIT_TAG}
endif
